...
<?php
include "feedback.php"; // connection file with database
$query = "SELECT * FROM feedback"; // get the records on which pie chart is to be drawn
            ...
            data: [
                ...
                if ($getData->num_rows>0){
                    while ($row = $getData->fetch_object()){
                        $data.='{ name:"'.$row->rating.'",y:'.$row->overall.'},';
                    }
                }
                echo $data;
                ?>
